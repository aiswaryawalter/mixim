...
class Network:
    ...
    # def sample_latency_aware_path_free_route(self, tau, sender_server_id, receiver_server_id, n_hops):
    #     """
    #     Sample a latency-aware path through free route network
        
    #     Args:
    #         tau: exploration parameter (0 = deterministic, 1 = uniform random)
    #         sender_server_id: server ID of sender
    #         receiver_server_id: server ID of receiver  
    #         n_hops: desired number of hops through mix network
        
    #     Returns:
    #         List of mix nodes forming the path
    #     """
    #     # Get all mixes (they're all in layer 1 for free route)
    #     all_mixes = self.network_dict[1] if 1 in self.network_dict else []
